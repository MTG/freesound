...
11. Install static build dependencies

        docker compose run --rm web npm install

12. Build static files. Note that this step will need to be re-run every time there are changes in Freesound's static code (JS, CSS and static media files).
...
14. Build the search index, so you can search for sounds and forum posts
