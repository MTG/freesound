...
Name                    Type                       Description
======================  =========================  ======================
``similarity_space``    string                     Indicates the similarity space used when performing similarity search. If not defined, the default similarity space is used. Should be one of the :ref:`available similarity spaces <search-similar>`.
