...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.enabled_stream_emails'
        db.add_column('accounts_profile', 'enabled_stream_emails', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.enabled_stream_emails'
        db.delete_column('accounts_profile', 'enabled_stream_emails')
    ...
    models = {
        'accounts.profile': {
            ...
            'enabled_stream_emails': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
