...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Profile', fields ['enabled_stream_emails']
        db.create_index('accounts_profile', ['enabled_stream_emails'])


    def backwards(self, orm):
        
        # Removing index on 'Profile', fields ['enabled_stream_emails']
        db.delete_index('accounts_profile', ['enabled_stream_emails'])
