...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.last_stream_email_sent'
        db.add_column('accounts_profile', 'last_stream_email_sent', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.last_stream_email_sent'
        db.delete_column('accounts_profile', 'last_stream_email_sent')
