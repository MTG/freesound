...
def flag_user(context, flag_type, username, content_id, text = None, user_sounds = None):
    ...
    return {'user_sounds':user_sounds,'done_text':"Marked as spam", 'flagged':len(flagged),'flag_type':flag_type,'username':username, 'content_obj_id':content_id, 'media_url': context['media_url'], 'link_text':link_text}
