...
urlpatterns = patterns('accounts.views',
    ...
    url(r'^activate/(?P<activation_key>[^//]+)/(?P<username>\w+)/$', accounts.activate_user, name="accounts-activate"),
    url(r'^activate2/(?P<username>[^\/]+)/(?P<hash>[^\/]+)/.*$', accounts.activate_user2, name="accounts-activate2"),
    url(r'^resetpassword/$',
