    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oauth_client', models.OneToOneField(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='apiv2_client', to='provider.Client')),
