...
import {
  bindUserAnnotationsModal,
  activateUserAnnotationsModalIfParameters,
} from '../components/userAnnotationsModal.js';
...
} from '../components/remixGroupModal.js';
import {
  bindSimilarSoundsModal,
  activateSimilarSoundsModalIfParameters,
} from '../components/similarSoundsModal.js';
...
const initializeStuffInContainer = (container, bindModals, activateModals) => {
  ...
  maps.forEach(map => {
    ...
    const mapIsBehindStaticMap =
      staticMapWrapper !== null &&
      staticMapWrapper.parentNode == map.parentNode;
