...
```jsx
const DevWrapperDoNotUseInProduction = ({ children }) => (
  <div style={{ transform: 'translateX(0)', height: 100 }}>{children}</div>
);

<DevWrapperDoNotUseInProduction>
  <nav class="bw-nav bw-nav--home bw-nav--expanded">
