...
urlpatterns = [
    ...
    path('people/<username>/sounds/<int:sound_id>/sed/<int:sed_experiment>', sounds.views.sound, name="sound"),
    path('api/sound/<int:sound_id>/analysis/', sounds.views.get_sed_data, name='sed-data'),
    path('people/<str:username>/sounds/<int:sound_id>/download/', sounds.views.sound_download, name="sound-download"),
