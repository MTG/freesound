...
class CollectionTest(TestCase):
    ...
    def test_collections_create_and_delete(self):
        ...
        resp = self.client.get(reverse("collection", args=[slugify(self.collection.name), self.collection.id]))
        self.assertEqual(resp.status_code, 200)
    ...
    def test_add_remove_sounds_as_external_user(self):
        ...
        resp = self.client.get(reverse("edit-collection", args=[slugify(self.collection.name), self.collection.id]))
