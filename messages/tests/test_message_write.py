...
class UsernameLookup(TestCase):
    ...
    def test_get_previously_contacted_usernames(self):
        ...
        self.assertCountEqual(
            [
                self.receiver3.username,
                self.receiver2.username,
                self.receiver1.username,
                self.sender2.username,
    ...
    def test_username_lookup_response(self):
        ...
        self.assertCountEqual(
            [self.receiver3.username, self.receiver2.username, self.receiver1.username], response_json
        )
