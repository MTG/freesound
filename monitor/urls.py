...
urlpatterns = [
    ...
    url(r'^stats/$',
        ...
        name='monitor-stats'),
    url(r'^stats/api$', TemplateView.as_view(template_name='monitor/api_usage.html'),
        name='monitor-api-stats'),
    ...
    url(r'^ajax_api_usage_stats/$', monitor.views.api_usage_stats_ajax,
