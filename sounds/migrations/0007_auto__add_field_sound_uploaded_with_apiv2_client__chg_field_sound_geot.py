...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sound.uploaded_with_apiv2_client'
        db.add_column('sounds_sound', 'uploaded_with_apiv2_client',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['apiv2.ApiV2Client'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


        # Changing field 'Sound.geotag'
        db.alter_column('sounds_sound', 'geotag_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geotags.GeoTag'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Sound.pack'
        db.alter_column('sounds_sound', 'pack_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sounds.Pack'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Deleting field 'Sound.uploaded_with_apiv2_client'
        db.delete_column('sounds_sound', 'uploaded_with_apiv2_client_id')


        # Changing field 'Sound.geotag'
        db.alter_column('sounds_sound', 'geotag_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geotags.GeoTag'], null=True))

        # Changing field 'Sound.pack'
        db.alter_column('sounds_sound', 'pack_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sounds.Pack'], null=True))
    ...
    models = {
        ...
        'oauth2.client': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'8cfd1a76f98087d177de'", 'max_length': '255'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "'0013cb352cd5d2a4d4b8c1dea910c7eab62d83c9'", 'max_length': '255'}),
